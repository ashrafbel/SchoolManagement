  ...
  <div className="container px-4 mx-auto relative lg:text-sm">
    <div className="flex justify-between items-center">
      ...
      <div className="hidden lg:flex justify-center space-x-12 items-center">
        ...
        <a
          href="#"
          className="bg-gradient-to-r from-orange-500 to-orange-800 py-2 px-3 rounded-md text-white hover:opacity-80 transition-opacity"
        >
          Create an account
        </a>
      </div>
    ...
    {mobileDrawerOpen && (
      <div className="fixed right-0 z-20 bg-neutral-900 w-full p-12 flex flex-col justify-center items-center lg:hidden">
        ...
        <div className="flex space-x-6">
          ...
          <a
            href="#"
            className="py-2 px-3 rounded-md bg-gradient-to-r from-orange-500 to-orange-800 text-white hover:opacity-80 transition-opacity"
          >
            Create an account
          </a>
        </div>
